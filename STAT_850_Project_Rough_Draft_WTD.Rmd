...
$$y_{ijk}=\mu + w_i+m_j+\epsilon_{ijk}$$
where 
...
```{r plot-acf-dispatch, fig.cap='Autocorrelation plot of daily dispatch counts. This verifies that daily observations can be assumed to have independence from discernible trends'}
plot_acf_dispatch
```
